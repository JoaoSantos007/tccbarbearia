...
-- Copiando dados para a tabela barbearia_db.agendamentos: ~11 rows (aproximadamente)
DELETE FROM `agendamentos`;
INSERT INTO `agendamentos` (`id`, `id_usuario`, `id_funcionario`, `id_servicos`, `data`, `status`, `feedback`) VALUES
	(24, 1, 1, 1, '2026-05-05 12:00:00', 'agendado', NULL),
	(25, 2, 2, 3, '2026-05-05 13:00:00', 'confirmado', NULL),
	(26, 3, 3, 6, '2026-05-06 17:00:00', 'agendado', NULL),
	(27, 4, 1, 2, '2026-05-07 14:00:00', 'agendado', NULL),
	(29, 1, 2, 3, '2026-04-20 12:30:00', 'concluido', 'Ótimo atendimento, saí muito satisfeito!'),
	(30, 2, 1, 1, '2026-04-18 13:00:00', 'concluido', 'Corte perfeito como sempre.'),
	(31, 3, 3, 5, '2026-04-15 19:00:00', 'concluido', 'Rápido e bem feito.'),
	(32, 4, 2, 7, '2026-04-10 14:30:00', 'concluido', NULL),
	(35, 6, 2, 1, '2026-04-22 12:00:00', 'cancelado', NULL),
	(36, 1, 1, 8, '2026-04-30 18:29:00', 'concluido', NULL),
	(39, 11, 2, 3, '0000-00-00 00:00:00', 'agendado', NULL);
...
-- Copiando dados para a tabela barbearia_db.agendavalor: ~0 rows (aproximadamente)
...
INSERT INTO `servicos` (`id_servicos`, `nome`, `preco`, `duracao`, `pontos`, `status`) VALUES
	...
	(7, 'Barba', 20.00, 20, 20, 0),
	(8, 'Barba', 80.00, 30, 100, 0);
