...
-- Copiando dados para a tabela barbearia_db.agendamentos: ~13 rows (aproximadamente)
...
INSERT INTO `agendamentos` (`id`, `id_usuario`, `id_funcionario`, `data`, `status`, `feedback`, `forma_pagamento`) VALUES
	...
	(50, 14, 6, '2026-09-15 18:37:09', 'cancelado', NULL, 'Pix'),
	(51, 13, 7, '2026-08-03 20:30:00', 'cancelado', NULL, 'Pix'),
	(53, 20, 4, '2026-09-15 18:36:58', 'concluido', NULL, 'Transferência'),
	(54, 19, 4, '2026-08-06 17:09:00', 'cancelado', NULL, 'Pix'),
	(55, 21, 2, '2026-09-15 18:30:48', 'cancelado', NULL, 'Pix'),
...
-- Copiando dados para a tabela barbearia_db.agendavalor: ~49 rows (aproximadamente)
...
-- Copiando dados para a tabela barbearia_db.fidelidade: ~9 rows (aproximadamente)
...
-- Copiando dados para a tabela barbearia_db.funcionario: ~8 rows (aproximadamente)
