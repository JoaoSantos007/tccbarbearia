...
-- Copiando dados para a tabela barbearia_db.agendamentos: ~7 rows (aproximadamente)
...
INSERT INTO `agendamentos` (`id`, `id_usuario`, `id_funcionario`, `data`, `status`, `feedback`, `forma_pagamento`) VALUES
	...
	(46, 13, 3, '2026-05-08 19:00:00', 'concluido', NULL, 'Cartão Crédito'),
	...
	(50, 15, 6, '2026-05-12 20:00:00', 'concluido', NULL, 'Pix');
...
-- Copiando dados para a tabela barbearia_db.agendavalor: ~22 rows (aproximadamente)
...
-- Copiando dados para a tabela barbearia_db.funcionario: ~6 rows (aproximadamente)
DELETE FROM `funcionario`;
INSERT INTO `funcionario` (`id_funcionario`, `nome`, `funcao`) VALUES
	(1, 'João Silva', 'Barbeiro'),
	(2, 'Pedro Souza', 'Barbeiro'),
	(3, 'Gustavo Lima', 'Estilista'),
	(4, 'Carlos Mendes', 'Barbeiro'),
	(6, 'Gabriel Sampaio', 'Barbeiro Iniciante'),
	(7, 'Enzo Serra', 'Barbeiro');
...
-- Copiando dados para a tabela barbearia_db.historico_resgates: ~2 rows (aproximadamente)
...
INSERT INTO `historico_resgates` (`id`, `id_usuario`, `id_servico`, `pontos_gastos`, `data_resgate`) VALUES
	...
	(3, 15, 5, 50.00, '2026-05-12 11:22:24');
...
-- Copiando dados para a tabela barbearia_db.servicos: ~5 rows (aproximadamente)
...
-- Copiando dados para a tabela barbearia_db.usuarios: ~13 rows (aproximadamente)
DELETE FROM `usuarios`;
INSERT INTO `usuarios` (`id_usuario`, `nome_completo`, `email`, `senha`, `cep`, `primeiro_acesso`, `perfil`) VALUES
	(1, 'Joao Pedro', 'joao@gmail.com', '$2b$10$vJHIiRkGhB/rsXfWVde3GOHYC5OKdnE0.QEfxEFocCEdU8chowLR6', '12345678', 0, 'admin'),
	(2, 'Gustavo Alves', 'gus@gmail.com', '$2b$10$eEyDWOjiGg7KJa1c1lyLo.S4QDX9P7rqBssjr6KCU3/gv6mHzMjAW', '5161556165', 0, 'cliente'),
	(3, 'Maria Fernanda', 'maria@gmail.com', '$2b$10$vJHIiRkGhB/rsXfWVde3GOHYC5OKdnE0.QEfxEFocCEdU8chowLR6', '01310100', 0, 'cliente'),
	(4, 'Rafael Oliveira', 'rafael@hotmail.com', '$2b$10$vJHIiRkGhB/rsXfWVde3GOHYC5OKdnE0.QEfxEFocCEdU8chowLR6', '04538133', 0, 'cliente'),
	(5, 'Carla Santos', 'carla@yahoo.com', '$2b$10$vJHIiRkGhB/rsXfWVde3GOHYC5OKdnE0.QEfxEFocCEdU8chowLR6', '22041011', 0, 'cliente'),
	(6, 'Bruno Costa', 'bruno@gmail.com', '', '30130010', 1, 'cliente'),
	(7, 'Ana Lima', 'ana@gmail.com', '$2b$10$XozFdVNFwDENnQfcmsIC8.zLi3l5c8VwbaAUyM4IH3EI8CbS7e2Vm', '40020020', 0, 'cliente'),
	(9, 'Leonardo', 'leonardo@gmail.com', '$2b$10$32vkHxb2ri57AfuF0nxKOuc5QVWEKT9zC9CEbWVOSYNnzpNt4d70K', '12345678', 0, 'cliente'),
	(10, 'Ana Lima', 'ana2@gmail.com', '$2b$10$6icfWrUAsmgkayMrlBRt1evtzPi6VXHyTda7Htr.39cPbFt5U.OYW', '12345678', 0, 'cliente'),
	(11, 'felipe', 'leo@gmail.com', '$2b$10$vdZ5aDY4zRauokMG6v2BlOgfW.QWTSnMiAIQZpCPACAFjE0bTz/zq', '18028040', 0, 'cliente'),
	(12, 'Kaua', 'kaua@gmail.com', '$2b$10$TSGTe4zFm7mz2eriey1xgeVQvG16MbsI2T6IMBBWOF4u/G5DuqlpW', '12345678', 0, 'cliente'),
	(13, 'Antonio', 'antonio@gmail.com', '$2b$10$.ajbKwthWr4BqQcu889g8eIO5bbSdZs3kjbEW1X00b5q7Jn8927/W', '13265478', 0, 'cliente'),
	(14, 'Matheus Bernardes Rodrigues', 'rodriguinho@gmail.com', '$2b$10$7uV9iZ2HbE6FAV3Y75Nww..wCe7BdPENInFLGxupl.RUHPqFdWrIK', '12345678', 0, 'cliente'),
	(15, 'Leo Miguel', 'leoney@gmail.com', '$2b$10$BdzyJw2HMfyS1JQVUCYHruwzhY3hpV8KOoz8o3NMISLEZl8sRBh8W', '19028040', 0, 'cliente');
