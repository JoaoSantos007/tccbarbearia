...
-- Copiando dados para a tabela barbearia_db.agendamentos: ~2 rows (aproximadamente)
...
-- Copiando dados para a tabela barbearia_db.agendavalor: ~6 rows (aproximadamente)
...
-- Copiando dados para a tabela barbearia_db.fidelidade: ~2 rows (aproximadamente)
...
-- Copiando dados para a tabela barbearia_db.historico_resgates: ~1 rows (aproximadamente)
...
-- Copiando dados para a tabela barbearia_db.usuarios: ~11 rows (aproximadamente)
